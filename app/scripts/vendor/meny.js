    ...
    create: function(options) {
        return function() {
            ...
            function setupMenu() {
                ...
                } else Meny.extend(style, menuStyleClosed)
            }
            ...
            function bindEvents() {
                if ("ontouchstart" in window) if (config.touch) {
            ...
            function onTouchMove(event) {
                ...
                if (Math.abs(touchMoveX - touchStartX) > Math.abs(touchMoveY - touchStartY)) if (touchMoveX < touchStartX - config.threshold) swipeMethod = onSwipeRight;
                else {
    ...
    animate: function(element, properties, duration, callback) {
        return function() {
            ...
            function step() {
                ...
                if (progress < 1) animationTimeout = setTimeout(step, 1E3 / 60);
                else {
                    callback && callback();
                    stop()
                }
